## Week 4: File Copier with Progress Bar

**Goal:** Copy a file from source to destination, showing progress percentage.

**Skills:** `os` file I/O, goroutines, channels, `io.Copy`.
