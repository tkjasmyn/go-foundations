...
| Thu | —                                           | —                            | Task Scheduler: REBUILD from scratch (one-time delays only)                         | ⬜     |
| Fri | product except self (BUGGY, zero hints)     | —                            | Task Scheduler: add list command if rebuild passed                                  | ⬜     |
